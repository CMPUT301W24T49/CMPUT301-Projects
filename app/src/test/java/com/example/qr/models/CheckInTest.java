...
public class CheckInTest {
    ...
    public void testCheckInCreation() {
        ...
        CheckIn checkIn = new CheckIn("checkIn123", "event789", "user123", checkInTime, location);

        assertEquals("checkIn123", checkIn.getId());
    ...
    public void testSettersAndGetters() {
        ...
        assertEquals("checkIn456", checkIn.getId());
